...
describe('GLTexture', () => {
  ...
  test('创建纹理', () => {
    texture.create(4, 4, GLConstants.TEXTURE_FORMAT.RGBA, GLConstants.DATA_TYPE.UNSIGNED_BYTE);
  ...
  test('设置纹理参数', () => {
    ...
    texture.setParameters({
      minFilter: GLConstants.TEXTURE_FILTER.LINEAR,
      magFilter: GLConstants.TEXTURE_FILTER.LINEAR,
      wrapS: GLConstants.TEXTURE_WRAP.REPEAT,
      wrapT: GLConstants.TEXTURE_WRAP.REPEAT
    });
