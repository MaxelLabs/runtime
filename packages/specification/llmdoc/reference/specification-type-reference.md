...
- **架构设计**: `packages/specification/llmdoc/architecture/specification-type-system.md` - 类型系统整体架构
- **编码约定**: `/llmdoc/reference/coding-conventions.md` - TypeScript 编码规范
- **重复类型分析**: `packages/specification/docs/duplicate-analysis-report.md` - 类型重复问题分析
- **重构完成报告**: `packages/specification/docs/refactoring-completion-report.md` - 重构过程和结果