...
describe('Matrix4', () => {
  ...
  describe('构造函数和基础属性', () => {
    ...
    test('应该正确获取和设置矩阵元素', () => {
      ...
      m.set(
        testElements[0], testElements[4], testElements[8], testElements[12],
        testElements[1], testElements[5], testElements[9], testElements[13],
        testElements[2], testElements[6], testElements[10], testElements[14],
        testElements[3], testElements[7], testElements[11], testElements[15]
      );
  ...
  describe('性能测试', () => {
    test('基础运算性能', () => {
      ...
      performanceTest('Matrix4.multiply', () => {
        m1.multiply(m2);
      }, 5000);

      performanceTest('Matrix4.transformVector3', () => {
        m1.transformVector(v);
      }, 10000);

      performanceTest('Matrix4.invert', () => {
        m1.invert();
      }, 1000);
    });
  });
