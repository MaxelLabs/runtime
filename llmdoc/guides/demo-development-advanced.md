---
title: "高级渲染系统开发指南"
description: "RHI Demo第三层光照系统和第四层高级渲染系统的完整开发指南，包括PBR材质、阴影映射、粒子系统、实例化渲染和后处理效果"
tags: ["demo-development", "advanced-rendering", "pbr", "shadows", "particles", "instancing", "post-processing"]
category: "guide"
audience: "developer"
version: "1.0.0"
last_updated: "2025-12-17"
related_docs: ["demo-development-fundamentals.md", "demo-development-textures.md", "../reference/pbr-material-system.md"]
prerequisites: ["demo-development-textures.md", "../reference/api-v2/rhi/", "../reference/api-v2/math/"]
complexity: "advanced"
